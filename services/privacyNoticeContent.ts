 ...
 *
 * Regla de transparencia: solo declarar tratamientos que el código realiza hoy
 * o está a punto de activar por feature flag. Sin sobre-promesas (biómetros/liveness).
 */
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'Los datos contenidos en la Credencial para Votar (INE) se tratan con medidas de seguridad reforzadas.',
        ],
        bullets: [
          'Datos de identificación: nombre completo, fecha de nacimiento, sexo, fotografía impresa en la credencial, CURP, Clave de Elector, CIC, OCR / Identificador de Ciudadano, número de emisión de la credencial, domicilio, sección electoral y demás datos contenidos en la Credencial para Votar (INE/IFE).',
      ...
      },
      {
        ...
        bullets: [
          'Proveedores de servicios de verificación de identidad y KYC que cuenten con acceso autorizado a la Lista Nominal del INE o a bases de datos oficiales (bajo contratos de confidencialidad y encargados de tratamiento), incluyendo proveedores como Datos Non Stop u otros autorizados, únicamente cuando dicha función esté habilitada.',
      ...
      },
      {
        ...
        paragraphs: [
          'Al utilizar la App, cargar su Credencial para Votar o proporcionar sus datos personales, usted manifiesta haber leído, entendido y aceptado los términos del presente Aviso de Privacidad, otorgando su consentimiento para el tratamiento de sus datos conforme a lo aquí establecido.',
        ],
      },
    ],
